...
`);for(w=0;w<c.length;++w)/^ {0,3}\|/.test(c[w])&&(c[w]=c[w].replace(/^ {0,3}\|/,"")),/\|[ \t]*$/.test(c[w])&&(c[w]=c[w].replace(/\|[ \t]*$/,"")),c[w]=r.subParser("codeSpans")(c[w],u,d);var m=c[0].split("|").map(function(R){return R.trim()}),v=c[1].split("|").map(function(R){return R.trim()}),C=[],L=[],j=[],U=[];for(c.shift(),c.shift(),w=0;w<c.length;++w)c[w].trim()!==""&&C.push(c[w].split("|").map(function(R){return R.trim()}));if(m.length<v.length)return g;for(w=0;w<v.length;++w)j.push(f(v[w]));for(w=0;w<m.length;++w)r.helper.isUndefined(j[w])&&(j[w]=""),L.push(i(m[w],j[w]));for(w=0;w<C.length;++w){for(var O=[],G=0;G<L.length;++G)r.helper.isUndefined(C[w][G]),O.push(l(C[w][G],j[G]));U.push(O)}return y(L,U)}return e=d.converter._dispatch("tables.before",e,u,d),e=e.replace(/\\(\|)/g,r.helper.escapeCharactersCallback),e=e.replace(n,b),e=e.replace(o,b),e=d.converter._dispatch("tables.after",e,u,d),e}),r.subParser("underline",function(e,u,d){return u.underline&&(e=d.converter._dispatch("underline.before",e,u,d),u.literalMidWordUnderscores?(e=e.replace(/\b___(\S[\s\S]*?)___\b/g,function(n,o){return"<u>"+o+"</u>"}),e=e.replace(/\b__(\S[\s\S]*?)__\b/g,function(n,o){return"<u>"+o+"</u>"})):(e=e.replace(/___(\S[\s\S]*?)___/g,function(n,o){return/\S$/.test(o)?"<u>"+o+"</u>":n}),e=e.replace(/__(\S[\s\S]*?)__/g,function(n,o){return/\S$/.test(o)?"<u>"+o+"</u>":n})),e=e.replace(/(_)/g,r.helper.escapeCharactersCallback),e=d.converter._dispatch("underline.after",e,u,d)),e}),r.subParser("unescapeSpecialChars",function(e,u,d){return e=d.converter._dispatch("unescapeSpecialChars.before",e,u,d),e=e.replace(/¨E(\d+)E/g,function(n,o){var f=parseInt(o);return String.fromCharCode(f)}),e=d.converter._dispatch("unescapeSpecialChars.after",e,u,d),e}),r.subParser("makeMarkdown.blockquote",function(e,u){var d="";if(e.hasChildNodes())for(var n=e.childNodes,o=n.length,f=0;f<o;++f){var i=r.subParser("makeMarkdown.node")(n[f],u);i!==""&&(d+=i)}return d=d.trim(),d="> "+d.split(`
`).join(`
...
`;function _d(){const t=new ld.Converter,a=hd;return t.makeHtml(a)}function pd(){const t={__html:_d()};return P(Z,{children:P("div",{className:"markdown-div",dangerouslySetInnerHTML:t})})}function md(){return P(Z,{children:P(gd,{})})}function gd(){const[t,a]=Ge("portfolio"),s=document.querySelector(".contentContainer");Ze(()=>{s.addEventListener("click",r)},[]);function r(p){switch(p.target.id){case"writeups-dir":a("writeups");break;case"coding-dir":a("coding");break;case"portfolio-dir":a("portfolio");break;case"portfolio-path-dir":a("portfolio");break;default:return}}return P(Z,{children:[P("div",{className:"port-nav-container",style:"display:flex",children:[P("p",{children:"/home/trshpuppy/"}),P("p",{id:t==="portfolio"?"":"portfolio-path-dir",className:t==="portfolio"?"":"portfolio-nav-btn",children:"portfolio/"}),P("a",{style:"margin:16px; margin-left:0;",children:t!="portfolio"?t:""}),P("button",{id:t==="portfolio"?"writeups-dir":"portfolio-path-dir",className:"portfolio-nav-btn",children:t=="portfolio"?"Writeups":"Back"}),P("button",{id:"coding-dir",className:t==="portfolio"?"portfolio-nav-btn":"hidden",children:t=="portfolio"?"Coding":""})]}),P(bd,{currentDir:t})]})}function bd(t){return t.currentDir=="portfolio"?P("div",{className:"port-content-container",children:P(wd,{})}):t.currentDir=="writeups"?P("div",{className:"port-content-container",children:P(pd,{})}):P("div",{className:"port-content-container",children:P("p",{children:"Coding"})})}function wd(t){return P(Z,{children:[P("h1",{children:"Welcome to my Portfolio!"}),P("h2",{children:[" ","Here you'll find various writeups and projects I've been working on, all related to cybersecurity and coding!"]}),P("div",{className:"context-container",children:P(X,{tag:"writeups",orientation:"row",chillins:[{type:"section",element:P(X,{tag:"p",orientation:"column",chillins:[{type:"p",attrs:void 0,text:"If you'd like to see cybersecurity writeups and content change directory into 'Writeups'. Else, cd into 'Coding'.",child:void 0}]})}]})})]})}function yd(){return P("div",{children:"Contact"})}function vd(){return P(Z,{children:[P("div",{id:"nav-container",className:"nav-container",children:P(id,{})}),P("div",{id:"content-container",className:"contentContainer",children:P(kd,{})})]})}function kd(){const[t,a]=Ge("Home"),s=He(null),r=He(null);Ze(()=>(r.current=document.querySelector(".linkbox-container"),s.current=document.getElementById("nav-container"),s.current&&s.current.addEventListener("click",p),r.current&&r.current.addEventListener("click",h),()=>{s.current&&s.current.removeEventListener("click",p),r.current&&r.current.removeEventListener("click",h)}),[t]);function p(T){switch(T.target.id){case"portfolio-btn":a("Portfolio");break;case"about-btn":a("About");break;case"contact-btn":a("Contact");break;default:a("Home")}}function h(T){switch(T.target.id){case"paper-gif":a("Portfolio");break;case"tp-wag-gif":a("About");break;case"star-gif":a("Contact");break;default:a("Home")}}let k;switch(t){case"Portfolio":k=md;break;case"About":k=sd;break;case"Contact":k=yd;break;default:k=od}return P(k,{})}ud(P(vd,{}),document.getElementById("app"));
